...
// returns a new buffer with reversed values
// see https://github.com/zone117x/node-cryptonote-pool/issues/93#issuecomment-157628147
function reverseBuffer(buffer) {
    var bytes = Array.prototype.slice.call(buffer, 0);
...
Miner.prototype = {
    ...
    getTargetHex: function(){
        ...
        var buffReversed = reverseBuffer(buff);
...
function processShare(miner, job, blockTemplate, nonce, resultHash){
    ...
    var hashNum = bignum.fromBuffer(reverseBuffer(hash));
